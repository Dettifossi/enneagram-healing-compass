...
- Bei unklaren/breiten Suchen (>3 Grep-Anfragen absehbar): Explore-Agenten nutzen statt selbst mehrfach zu grep'en.
...
Details zu Technik, Großdatei-Regel und Inhaltsregeln stehen in [SECOND_BRAIN.md](SECOND_BRAIN.md) — nur bei Bedarf öffnen (z. B. neues Feature, Setup-Frage, Content-Zweifel), nicht bei jeder Anfrage.
